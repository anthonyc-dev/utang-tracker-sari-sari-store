...
import { Loader2, Eye, EyeOff, CircleAlert, Store } from "lucide-react";
        ...
        <main className="w-full min-h-screen grid md:grid-cols-2 overflow-hidden shadow-xl bg-linear-to-b from-indigo-50/60 to-white bg-white">
            ...
            <div className="flex flex-col justify-center p-8 sm:p-12 bg-linear-to-b to-white">
                <div className="w-full max-w-lg mx-auto ">
                    ...
                    <p className="text-neutral-500 text-sm mb-8">Please enter log in details below</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <Input
                                ...
                                placeholder="Email"
                                required
                                className="h-11 bg-white border-neutral-200 rounded-lg px-4"
                            />
                        </div>
                    ...
                    >
                        ...
                        {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Log in with Google"}
                    </Button>
